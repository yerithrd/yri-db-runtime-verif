\documentclass[10pt,YRIDBRUNTIMEVERIFPAPERSPEC]{article} % use larger type; default would be 10pt
...
\usepackage{geometry}
\geometry{YRIDBRUNTIMEVERIFPAPERSPEC,
		  %showframe=true,
		  top=3.5em,
		  left=3em,
		  right=3em,
...
bookmarks,
plainpages=false,
pdftitle={(YRIDBRUNTIMEVERIFPRINTTIME) - yri-db-runtime-verif - CONSOLE RAW LOG EXCERPT},
pdfauthor={yri-db-runtime-verif, YERITH R\&D}
}
...
\headerrow
	{\textbf{YERITH\_QVGE (YR\_QVGE): Test and Design System for Software System.}}
	{}
\headerrow
	{}
	{}
\headerrow
	{}
	{\textbf{\underline{YRIDBRUNTIMEVERIFDATE}}}


\vspace*{0.9cm}


\section*{\underline{YRIDBRUNTIMEVERIFSUBJECT}}

\textbf{Time of print:} YRIDBRUNTIMEVERIFPRINTTIME

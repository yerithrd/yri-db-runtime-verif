/*
* YERITH_QVGE_sample_SAFETY_PROPERY_one_Recovery_SAMPLE.cpp
*
*/

#include "YERITH_QVGE_sample_SAFETY_PROPERY_one_Recovery_SAMPLE.hpp"
...
void YERITH_QVGE_sample_SAFETY_PROPERY_one_Recovery_SAMPLE::YRI_CALL_BACK_final_state(YRI_CPP_MONITOR 			*a_runtime_monitor,
...
YERITH_QVGE_sample_SAFETY_PROPERY_one_Recovery_SAMPLE::YERITH_QVGE_sample_SAFETY_PROPERY_one_Recovery_SAMPLE()
    :YRI_DB_RUNTIME_VERIF_Monitor()
{
    set_RUNTIME_MONITOR_NAME("YERITH_QVGE_sample_SAFETY_PROPERY_one_Recovery_SAMPLE");
    ...
    a_last_edge_1->get_TARGET_STATE()->Set_SQL_RECOVERY_QUERY_STRING("'INSERT INTO categories (id, nom_categorie, nom_departement_produit) values (yri_id, `YRI_ASSET_cat`, `YRI_ASSET`)'");
...
YERITH_QVGE_sample_SAFETY_PROPERY_one_Recovery_SAMPLE::YERITH_QVGE_sample_SAFETY_PROPERY_one_Recovery_SAMPLE(YRI_DB_RUNTIME_VERIF_Logger *logger)
...
* METHOD !
*/
bool YERITH_QVGE_sample_SAFETY_PROPERY_one_Recovery_SAMPLE::DO_VERIFY_AND_or_CHECK_ltl_PROPERTY(
...
bool YERITH_QVGE_sample_SAFETY_PROPERY_one_Recovery_SAMPLE::YRI_SQL_SELECT_stocks()
{

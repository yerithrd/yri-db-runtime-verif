...
#define _YRI_DB_RUNTIME_DB_VERIF_DATABASE_TABLES_COLUMNS_HPP_
...
class YRI_DB_RUNTIME_VERIF_DatabaseTableColumn
{
public:
...
#endif /* _YRI_DB_RUNTIME_DB_VERIF_DATABASE_TABLES_COLUMNS_HPP_ */

...
QString YRI_DB_RUNTIME_VERIF_Utils::_mainWorkingDirectory("");

QString YRI_DB_RUNTIME_VERIF_Utils::_logFileName("yri-db-runtime-verif.log");

QString YRI_DB_RUNTIME_VERIF_Utils::temporaryFilesDir("/tmp");

const QString YRI_DB_RUNTIME_VERIF_Utils::EMPTY_STRING("");

const QString YRI_DB_RUNTIME_VERIF_Utils::USERS("users");
const QString YRI_DB_RUNTIME_VERIF_Utils::TITRES("titres");
const QString YRI_DB_RUNTIME_VERIF_Utils::LOCALISATIONS("localisations");
const QString YRI_DB_RUNTIME_VERIF_Utils::CATEGORIES("categories");
const QString YRI_DB_RUNTIME_VERIF_Utils::CLIENTS("clients");
const QString YRI_DB_RUNTIME_VERIF_Utils::FOURNISSEURS("fournisseurs");
const QString YRI_DB_RUNTIME_VERIF_Utils::ALERTES("alertes");
const QString YRI_DB_RUNTIME_VERIF_Utils::CONDITIONS_ALERTES("conditions_alertes");
const QString YRI_DB_RUNTIME_VERIF_Utils::COURRIERS_ALERTES("courriers_alertes");
const QString YRI_DB_RUNTIME_VERIF_Utils::STOCKS("stocks");
const QString YRI_DB_RUNTIME_VERIF_Utils::STOCKS_VENDU("stocks_vendu");



const QRegExp YRI_DB_RUNTIME_VERIF_Utils::EMPTY_SPACE_REGEXP("\\s");

const QLocale YRI_DB_RUNTIME_VERIF_Utils::englishLocale(QLocale(QLocale::English, QLocale::Zambia));



const QString YRI_DB_RUNTIME_VERIF_Utils::DATE_FORMAT("dd.MM.yyyy");

const QString YRI_DB_RUNTIME_VERIF_Utils::DB_DATE_FORMAT("yyyy-MM-dd");


const QString YRI_DB_RUNTIME_VERIF_Utils::TIME_FORMAT_WITH_MILLISECONDS(FORMAT_TIME_WITH_MS);

const QString YRI_DB_RUNTIME_VERIF_Utils::TIME_FORMAT("HH:mm:ss");


const QString YRI_DB_RUNTIME_VERIF_Utils::LOCALHOST("localhost");

const QString YRI_DB_RUNTIME_VERIF_Utils::LOCALHOST_IP_ADDRESS("127.0.0.1");


const QString YRI_DB_RUNTIME_VERIF_Utils::STRING_OUI("oui");

const QString YRI_DB_RUNTIME_VERIF_Utils::STRING_NON("non");


const unsigned int YRI_DB_RUNTIME_VERIF_Utils::FACTURE_PETIT_NOM_ARTICLE_MAX_CHARS(12);


const unsigned int YRI_DB_RUNTIME_VERIF_Utils::STRING_MAX_CHARS(18);


const QString YRI_DB_RUNTIME_VERIF_Utils::INFERIEUR_OU_EGAL("<=");

const QString YRI_DB_RUNTIME_VERIF_Utils::SUPERIEUR(">");


const QString YRI_DB_RUNTIME_VERIF_Utils::UTILISATEUR_NON_EXISTANT("unknown user");


const QString YRI_DB_RUNTIME_VERIF_Utils::JH_NISSI_CLIENT("yri.db-runtime.verif");
...
const QString YRI_DB_RUNTIME_VERIF_Utils::FILE_YRI_DB_RUNTIME_VERIF_EVENT_LOG_PDF_TEMPLATE_EN(":EN_template_EVENT_LOG_TEX_document.tex");



const QString YRI_DB_RUNTIME_VERIF_Utils::CSV_FILE_SEPARATION_SEMI_COLON_STRING_CHAR(";");


const QChar YRI_DB_RUNTIME_VERIF_Utils::SLASH_CHAR('/');
                                                 ...
                                                 const QDate &aDate)
{
    ...
    date_IN_OUT = YRI_DB_RUNTIME_VERIF_Utils::LATEX_IN_OUT_handleForeignAccents(date_IN_OUT);
}


void YRI_DB_RUNTIME_VERIF_Utils::getCurrentLocaleDate(QString 		&date_IN_OUT,
                                                     const QDate 	&aDate)
{
    QString d(YRI_DB_RUNTIME_VERIF_Utils::englishLocale.toString(aDate));
...
QString YRI_DB_RUNTIME_VERIF_Utils::getUniquePrefixFileInTemporaryFilesDir(QString aPrefixFileName)
{
    return QString("%1/%2.").arg(YRI_DB_RUNTIME_VERIF_Config::temporaryFilesDir,
...
{
	QString resultItemText(YRI_DB_RUNTIME_VERIF_Utils::LATEX_IN_OUT_handleForeignAccents(itemText));
...
int
YRI_DB_RUNTIME_VERIF_Utils::start_PROCESS_AND_GET_PROCESS_output_AS_QSTRING
                                                 ...
                                                 const QString &file_full_path)
{
    ...
    int file_size =
                    YRI_DB_RUNTIME_VERIF_Utils::start_PROCESS_AND_READ_PROCESS_output_INTO_FILE
                    ("/usr/bin/gzip",
                     program_working_directory_full_path,
...
QString YRI_DB_RUNTIME_VERIF_Utils::generateSqlLike__AS_IS(QString sqlTableColumn,
                                                          QString searchStr)
{
    QString result;
...
QString YRI_DB_RUNTIME_VERIF_Utils::generateSqlLike(QString sqlTableColumn,
                                                   QString searchStr)
{
    QString result;
...
bool YRI_DB_RUNTIME_VERIF_Utils::execQuery(const QString &strQuery,
                                          YRI_DB_RUNTIME_VERIF_Logger *logger)
{
    //qDebug() << "[YRI_DB_RUNTIME_VERIF_Utils][execQuery]";
...
int YRI_DB_RUNTIME_VERIF_Utils::execQuery(QSqlQuery &query,
...
int YRI_DB_RUNTIME_VERIF_Utils::getNextIdFromTable(const QString &tableName)
{
...
bool YRI_DB_RUNTIME_VERIF_Utils::SAVE_AS_csv_file(QMainWindow    &aCallingWindow,
	...
	for (int k = 0; k < a_calling_window_qheaderview->count(); ++k)
	{
		...
		if (anItem.isValid())
		{
			...
			csvFileContent.append(QString("\"%1\"%2 ")
                                    .arg(anItemText,
                                         YRI_DB_RUNTIME_VERIF_Utils::CSV_FILE_SEPARATION_SEMI_COLON_STRING_CHAR));
		}
	}
...
QString YRI_DB_RUNTIME_VERIF_Utils::LATEX_IN_OUT_handleForeignAccents(const QString &texText_in)
{
...
bool YRI_DB_RUNTIME_VERIF_Utils::start_db_transaction()
{
    return false;
}


bool YRI_DB_RUNTIME_VERIF_Utils::rollback_db_transaction()
{
    return false;
}


bool YRI_DB_RUNTIME_VERIF_Utils::commit_db_transaction()
{
    return false;
}


QString YRI_DB_RUNTIME_VERIF_Utils::get_text(const QVariant &qv)
{
    QString retStr;
    ...
    return YRI_DB_RUNTIME_VERIF_Utils::prepareSqlStr(retStr);
}

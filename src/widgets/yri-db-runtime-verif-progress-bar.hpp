/*
 * yri-db-runtime-verif-progress-bar.hpp
 *
 *      Author: Pr. Prof. Dr. Xavier Noundou
 */

#ifndef _YRI_DB_RUNTIME_VERIF_PROGRESS_BAR_HPP_
#define _YRI_DB_RUNTIME_VERIF_PROGRESS_BAR_HPP_
 ...
 */
template <class classType, typename parameterType, typename returnType>
void YRI_DB_RUNTIME_VERIF_ProgressBar::
 ...
 */
template <class classType, typename parameterType, typename returnType>
void YRI_DB_RUNTIME_VERIF_ProgressBar::call_funtion_with_progress_bar_updates(classType 		*aClassInstanceRef,
        													   parameterType 	*aParamValue,
															   returnType (classType::*func)(parameterType *),
															   returnType 		*aRetValue,
															   unsigned int 	progressBarMaximum)
...
#endif /* _YRI_DB_RUNTIME_VERIF_PROGRESS_BAR_HPP_ */
